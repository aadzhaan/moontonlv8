export default function DetailSubscription({name, isPremium, remainingActiveDays, activeDays}){
    ...
    {!isPremium &&
        ...
        <div className="p-5 bg-white rounded-[25px] outline outline-1 outline-[#f1f1f1]">
            ...
            <div className="rounded-full w-full h-[6px] bg-[#f1f1f1]">
                <div className={`rounded-full h-full ${percentageDays()} bg-alerange`}></div>
            </div>
        </div>
    </div>
    }
